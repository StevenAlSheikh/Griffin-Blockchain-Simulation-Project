...
public class Miner implements Runnable{
    ...
    public boolean doProofOfWork(Block oBlock) {
        String sZeroesString = "";
        int iNonce = 0;


        while(sZeroesString.length() < oBlock.getDifficulty()){
           sZeroesString = sZeroesString + "0";
       }
        ...
        while(true){
            ...
            if(bAbortPoW == true){
                bAbortPoW = false;
                System.out.println("[Miner] Aborted mining block, probably because another confirmed block has been received");
                return false;
            }
                ...
                if(oBlock.getHash().startsWith(sZeroesString)){
